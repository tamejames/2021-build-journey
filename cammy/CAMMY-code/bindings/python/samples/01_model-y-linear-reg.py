...
# 0. ABOUT THIS MODEL
# This model will take RGB values and predict a 'Y percent by paint vol' value.
# This is the proportion of acrylic yellow paint (by volume) required to recreate the RGB colour based on physical experiments. The data for these experiments are stored
...
# Set label for 'Y percent by paint vol'
labels = image_data.loc[:,'Y percent by paint vol']
...
filename = 'y_guess_model_linreg.sav'
pickle.dump(reg,open(filename,'wb'))
loaded_model = pickle.load(open('y_guess_model_linreg.sav', 'rb'))
